...
from src.config import ADDITIONAL_DATA_DIR, CLIMATE_DATA_DIR, HOMELESS_DATA_DIR, HOUSING_DATA_DIR, \
    SOCIAL_MEDIA_DATA_DIR, SOCIOECONOMIC_DATA_DIR

# Define allowed file extensions. Currently, we don't want to deal with JSON files, however, we can add it later.
